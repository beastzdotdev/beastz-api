export enum ExceptionMessageCode {
  ...
  FS_MUST_BE_TEXT_PLAIN = 'FS_MUST_BE_TEXT_PLAIN',
  ...
  FS_PUBLICS_SHARE_EXISTS = 'FS_PUBLICS_SHARE_EXISTS',
  FS_PUBLIC_SHARE_NOT_FOUND = 'FS_PUBLIC_SHARE_NOT_FOUND',
  ...
  // redis
  DOCUMENT_CURRENTLY_IN_EDIT_MODE = 'DOCUMENT_CURRENTLY_IN_EDIT_MODE',
  DOCUMENT_NOT_SHAREABLE = 'DOCUMENT_NOT_SHAREABLE',
